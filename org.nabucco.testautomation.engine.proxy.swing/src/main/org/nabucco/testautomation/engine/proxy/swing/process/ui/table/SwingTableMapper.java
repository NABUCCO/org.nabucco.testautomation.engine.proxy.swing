 ...
 */
public interface SwingTableMapper {

    /**
     * Maps the swing table to a {@link PropertyMap}.
     * 
     * @param parentMap
     *            the parent map
     * 
     ...
     */
    void createPropertyList(PropertyList propertyList) throws ProcessInvocationException;
